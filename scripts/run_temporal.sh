#!/bin/bash
#SBATCH --job-name=temporal_01
#SBATCH --account=torch_pr_926_general
#SBATCH --partition=l40s_public
#SBATCH --gres=gpu:l40s:1
#SBATCH --mem=40G
#SBATCH --time=06:00:00
#SBATCH --output=/scratch/ch5085/logs/temporal_%j.log
...
for N in 4 6 8; do
    echo "=== Temporal lambda=0.1: ${N}-view ==="
    python train.py \
        -s $SCENE_DIR \
        -m /scratch/ch5085/output/jumpingjacks_${N}views_temporal01 \
        --eval --is_blender \
