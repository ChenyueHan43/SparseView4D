...
def readNerfSyntheticInfo(path, white_background, eval, extension=".png", train_json="transforms_train.json", init_ply=""):
    print("Reading Training Transforms")
    train_cam_infos = readCamerasFromTransforms(
        path, train_json, white_background, extension)
    ...
    ply_path = init_ply if init_ply and os.path.exists(init_ply) else os.path.join(path, "points3d.ply")
    if not os.path.exists(ply_path):
